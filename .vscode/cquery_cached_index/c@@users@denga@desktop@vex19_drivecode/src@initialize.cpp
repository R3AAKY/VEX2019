...
pros::Motor left_mtr1(LEFT_MOTOR_FRONT);
pros::Motor left_mtr2(LEFT_MOTOR_BACK);
pros::Motor right_mtr1(RIGHT_MOTOR_FRONT);
pros::Motor right_mtr2(RIGHT_MOTOR_BACK);
